...
export default function LandingPage(props: LandingPageProps) {
  ...
  const isTabletMedia = useIsTabletMedia(props.isTablet);
  const isMobileMedia = useIsMobileMedia(props.isMobile);
      ...
      >
        ...
        <AppShell.Main pb={0} px={0}>
          ...
          <Down
            ...
            top={isMobileMedia || isTabletMedia ? "0" : "-3em"}
            style={{
              position: "relative",
          ...
          >
            <Flex
              direction={
                isMobileMedia ? "column" : isTabletMedia ? "column" : "row"
              }
              gap={"1em"}
              align={"start"}
              justify={"normal"}
