          ...
          <Container py={"xl"}>
            <Stack>
              ...
              <Text ta={"center"} size={"lg"} c={"var(--mantine-color-gray-6)"}>
                ...
                골치아픈 문제를 해결하고, 비효율적인 과정을 찾아 효율적으로
                개선할 수 있는 방법을 함께 고민하여 제공합니다.
              </Text>
            </Stack>
            ...
            <Stack>
              <Stack>
                ...
                <Text
                  ...
                  c={"var(--mantine-color-gray-6)"}
                >
                  문제해결에 꼭 개발이 필요하지 않을 수 있습니다. 언제 정말
                  개발이 필요한지 정확한 진단을 내려드릴 수 있으며 그 상황이
                      ...
                      <Group gap={"md"} align={"flex-start"} wrap="nowrap">
                        ...
                        <Stack gap={4}>
                          ...
                          <Text size={"sm"} c={"var(--mantine-color-gray-6)"}>
                            ...
                            해야만 했던 대시보드 제작 난이도를 낮추고 속도는
                            높여 필요한 시점에 필요한 팀에게 업무 데이터
                            가시성을 제공할 수 있게 됩니다.
                          </Text>
                        </Stack>
                      </Group>
            ...
            >
              <Card shadow={"xs"} p={"xl"}>
                <Stack>
                  ...
                  <Text>
                    우리가 하고 싶은 일이 있더라도, 고객에게 진짜 필요한 일을
                    먼저 합니다.
                  </Text>
                  <Text>
                    고객의 성공이 곧 우리의 성공입니다. 프루퍼팀은 고객의
                    비즈니스 성공을 위해 일합니다.
                  </Text>
                </Stack>
              </Card>
              <Card shadow={"xs"} p={"xl"}>
                <Stack>
                  ...
                  <Text>
                    같은 목표를 가지고 있다면 어떤 의견이라도 의심하기에 앞서
                    먼저 존중합니다.
                  </Text>
                  <Text>
