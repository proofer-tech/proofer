              ...
              <Group justify={"center"}>
                <Stack align={"center"}>
                  ...
                  <Stack align={"center"} gap={"xs"}>
                    ...
                    <Text>리디 사내 플랫폼 팀 개발자로 ERP, CRM 제공</Text>
                    <Text>
                      토스 재직중 사내직원관리 및 직원 통합서비스 제공
                    </Text>
                    <Text>
                      DevOps, 앱, 웹, 개발은 물론 디자인까지 능통한 서비스
                      전문가
                    </Text>
                  </Stack>
                </Stack>
                ...
                <Stack gap={"xl"}>
                  ...
                  <Stack gap={0}>
                    <Text>
                      ...
                      지표나 방법론과 같은 것들을 자세하게 분석하여 소개합니다.
                    </Text>
                  </Stack>
                </Stack>
              </Card>
                ...
                <Stack gap={"xl"}>
                  <Stack gap={"sm"}>
                    <Group>
                      ...
                      />
                      <Stack gap={0}>
                        <Text size={"xs"}>쉽고 빠른 노코드 대시보드 빌더</Text>
