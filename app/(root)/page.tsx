...
import { Button, Flex, Group, Image, Space } from "@mantine/core";
      ...
      >
        ...
        >
          <PlanCard
            ...
            name={"Free"}
            price={0}
            description={"프루퍼의 다양한 기능들을 무료로 먼저 사용해보세요!"}
            items={[
              "사용자 4명 이하",
              "생성 가능한 워크스페이스: 1개",
              "워크스페이스 당 프로젝트: 1개",
          ...
          <PlanCard
            ...
            cta={
              <Button fullWidth size={"md"} onClick={() => openTallyPopup()}>
                플랜 신청하기
              </Button>
            }
          />
